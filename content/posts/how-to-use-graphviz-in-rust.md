+++
title = 'How to use Graphviz in your Rust code'
...
The library also provides a builder that eases construction of the different types of [attributes](https://graphviz.org/doc/info/attrs.html).

Let's consider the following [graph](https://graphviz.org/Gallery/directed/fsm.html).
...
An even more flexible alternative is to use the [Graphviz command-line engine](https://graphviz.org/download/) directly:
