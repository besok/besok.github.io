...
draft = false
tags = ['zig', 'rust', 'systems-programming', 'jsonpath']
+++
...
The Rust version already existed ([jsonpath-rust](https://github.com/besok/jsonpath-rust)),
and the goal was to bring the same thing to Zig: [zig-jsonpath](https://github.com/besok/zig-jsonpath).
